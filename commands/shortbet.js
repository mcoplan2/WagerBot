...
module.exports = {
    ...
    async execute(messageCreate) {
        ...
        const newEmbed = new MessageEmbed()
            ...
            .setFooter({ text: `Token Cost: ${tokens}    |   Time Limit: 1 minute to enter   |   Duration: 5 minutes` })
        ...
        const collector = messageEmbed.createMessageComponentCollector({ filter, time: 75000});
