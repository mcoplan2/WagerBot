...
function updateLeaderboard(_x, _x2) {
                          ...
                          return _regeneratorRuntime().wrap(function _callee$(_context) {
                            while (1) switch (_context.prev = _context.next) {
                              ...
                              case 2:
                                ...
                                attachment = new MessageAttachment(canvas.toBuffer(), 'leaderboard.png'); // Send the embed with the leaderboard image to the Discord channel
                                _context.next = 14;
